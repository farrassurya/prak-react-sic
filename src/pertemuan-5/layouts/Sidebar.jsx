...
<div id="sidebar-menu" className="mt-10">
  <ul id="menu-list" className="space-y-3">
    <li>
      <div className="hover:text-hijau flex cursor-pointer items-center rounded-xl p-4 font-medium text-gray-600 hover:bg-green-50 transition-all space-x-4">
        <FaHome className="text-xl" /> {/* Icon Home ditambahkan di sini */}
        <span>Dashboard</span>
      </div>
    </li>
    <li>
